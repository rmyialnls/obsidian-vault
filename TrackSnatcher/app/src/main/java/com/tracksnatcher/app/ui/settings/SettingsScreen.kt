...
fun SettingsScreen(
    ...
    Scaffold(
        topBar = {
            // Banner-only header: the brand banner below carries the identity, so the bar
            // itself stays title-less rather than repeating "TrackSnatcher"/"Settings".
            TopAppBar(
                title = {},
                navigationIcon = {
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.brand_banner),
                contentDescription = "TrackSnatcher",
                contentScale = ContentScale.FillWidth,
                modifier = Modifier
                    .fillMaxWidth()
                    .aspectRatio(1200f / 593f),
            )
